...
def privacy_policy():
    ...
    <html>
    <head>
        <title>Privacy Policy - Voice Calendar Agent</title>
        <style>
            body {
    ...
    <body>
        <div class="container">
            <a href="/" class="back-link">← Back to Calendar Agent</a>
            <h1>Privacy Policy</h1>
            <p class="effective-date">Effective Date: December 16, 2025</p>
            
            <h2>1. Introduction</h2>
            <p>Welcome to Voice Calendar Agent. We respect your privacy and are committed to protecting your personal data. This privacy policy explains how we collect, use, and safeguard your information when you use our service.</p>
            
            <h2>2. Information We Collect</h2>
            <p>When you use Voice Calendar Agent, we collect:</p>
            <ul>
                <li><strong>Google Account Information:</strong> Email address and user ID when you authenticate via Google OAuth</li>
                <li><strong>Calendar Data:</strong> Access to your Google Calendar to create, read, update, and delete events</li>
                <li><strong>Voice Data:</strong> Audio recordings when you use voice input (processed via Groq's Whisper API and not stored)</li>
                <li><strong>Usage Data:</strong> Your interactions with the calendar agent to improve service functionality</li>
            </ul>
            
            <h2>3. How We Use Your Information</h2>
            <p>We use your information to:</p>
            <ul>
                <li>Authenticate you and provide access to the calendar service</li>
                <li>Create, modify, and delete calendar events on your behalf</li>
                <li>Process voice commands and convert them to text</li>
            ...
            <ul>
                <li>OAuth tokens are securely stored in our PostgreSQL database</li>
                <li>All communications use HTTPS encryption</li>
                <li>We never share your calendar data with third parties</li>
            ...
            <ul>
                <li><strong>Google Calendar API:</strong> To manage your calendar events</li>
                <li><strong>Groq API:</strong> For AI processing and voice transcription</li>
            </ul>
            ...
            <ul>
                ...
                <li>Revoke calendar access permissions at any time</li>
                <li>Logout and disconnect your Google account</li>
            </ul>
            
            <h2>7. Data Retention</h2>
            <p>We retain your OAuth tokens only while you maintain an active session. When you logout, your session data is cleared. Calendar events remain in your Google Calendar as per Google's policies.</p>
            
            <h2>8. Children's Privacy</h2>
            <p>Our service is not intended for users under the age of 13. We do not knowingly collect personal information from children.</p>
            
            <h2>9. Changes to This Policy</h2>
            <p>We may update this privacy policy from time to time. We will notify users of any material changes by updating the effective date.</p>
            
            <h2>10. Contact Us</h2>
            <p>If you have questions about this privacy policy, please contact us through the feedback option in the application.</p>
            
            <p style="margin-top: 40px; padding-top: 20px; border-top: 1px solid #ecf0f1; color: #7f8c8d; font-size: 14px;">
                By using Voice Calendar Agent, you agree to this privacy policy.
            </p>
        </div>
    </body>
    </html>
...
# ================== GRADIO MOUNTING ==================
# Mount Gradio AFTER all FastAPI routes are defined
